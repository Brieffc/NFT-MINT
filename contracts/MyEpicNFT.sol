...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Goku", "Charlie Brown", "Zeus", "Popeye", "Coringa", "Homen Aranha", "Perna Longa", "Batman", "Mr. Robot"];
  string[] secondWords = ["Adora", "Nao Vive Sem", "Ama", "Odeia", "Come", "Bebe", "Cheira", "Engoli", "Mastiga"];
  string[] thirdWords = ["Maconha", "Cerveja", "Whisky", "Vodka", "Cigarro", "Cachaca", "Ecstasy", "Mdma", "Cogumelo"];
